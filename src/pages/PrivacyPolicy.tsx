		...
		<PageContent title="Privacy policy" description="">
			...
			<div class="container text-black dark:text-white-dark">
				...
				<p class="mt-4">
					...
					about this on <a href='https://usefathom.com/compliance' target='_blank'>Fathom Analytics' website</a>.
				</p>
				<p class="mt-4">
					The purpose of us using this software is to understand our website traffic in the most
					privacy-friendly way possible so that we can continually improve our website. The
					lawful basis as per the GDPR is "Article 6(1)(f); where our legitimate interests are to improve our
					website and business continually." As per the explanation, no personal data is stored over time.
				</p>
			</div>
		</PageContent>
	)
